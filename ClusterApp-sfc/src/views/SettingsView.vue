      ...
      <template v-slot:after>
        ...
        >
          <q-tab-panel name="Personalization">
            ...
            >
            <div class="text-h4 q-mb-md">Personalization</div>
            ...
            <q-card class="card q-ma-md">
              ...
              <q-img v-else-if="authUser?.backgroundUrl?.trim() !== ''" :src="authUser.backgroundUrl"></q-img>
              <q-img v-else src="https://cdn.quasar.dev/img/parallax2.jpg"></q-img>
            </q-card>
            </div>
...
<!--Api key  -- https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyD_aETXW47xdmqKHjy7YFUgYjznGLdVQf4  -->
          ...
          <q-tab-panel name="AccountDetails">
            <div class="text-h4 q-mb-md">Account Information </div>
